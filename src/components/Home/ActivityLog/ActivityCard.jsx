    ...
    <div className="flex flex-col h-full bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="p-6 flex flex-col space-y-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold shadow-md hover:bg-blue-700 transition"
        >
          Read more
        </button>
      </div>
      ...
      {/* Pagination */}
      <div className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-between px-6 pb-4">
        <button
